    ...
    getFeatureInfo: function (evt) {
        ...
        jQuery.ajax({
            ...
            success: function (data, status, xhr) {
                var content = "<table>";
                content += "<thead><tr><th>Commune Information</th></tr></thead>";
                content += "<tbody>";
                for (var i = 0; i < data.features.length; i++) {
                    var feature = data.features[i];
                    var featureAttr = feature.properties;
                    console.log(featureAttr);
                    content += "<tr><td>Code insee : " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.insee_com) + "</td></tr>"
                        + "<tr><td>Population: " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.population) + "</td></tr>"
                        + "<tr><td>Population moyenne: " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.population_moyenne) + "</td></tr>"
                        + "<tr><td>Région: " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.region) + "</td></tr>"
                        + "<tr><td>Département: " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.departement) + "</td></tr>"
                        + "<tr><td>Dioxyde azote: " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.dioxyde_azote) + "</td></tr>"
                        + "<tr><td>Dioxyde azote limite: " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.dioxyde_azote_limite) + "</td></tr>"
                        + "<tr><td>Dioxyde azote moyenne: " + (jQuery.isEmptyObject(featureAttr) ? '' : featureAttr.dioxyde_azote_moyenne) + "</td></tr>";
                }
                content += "<tbody></table>";
                // $("#info").html(content);
                ...
                var insee_com = featureAttr.insee_com;
